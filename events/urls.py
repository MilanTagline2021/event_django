...
urlpatterns = [
    ...
    path('show_venue/<venue_id>', views.show_venue, name='show-venues'),
    path('search_venues', views.search_venue, name='search-venue'),
    ...
    path('show_events/<event_id>', views.show_events, name='show-events'),
]   